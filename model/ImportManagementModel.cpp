...
bool ImportManagementModel::ShowStatisticsFlowProductID(int id){
...
bool ImportManagementModel::ShowStatisticsFlowCategoryName(string name){
    bool FlagCheck = false;
...
bool ImportManagementModel::ShowStatisticsFlowSupplierName(string name){
    bool FlagCheck = false;
